        ...
        <div className="rounded-lg h-full">
            {
                <div id={ `upload-${ uploadId }` } className="relative h-full rounded-md bg-gray-100 shadow-inner">
                    <div className={ `motion-safe:animate-pulse transition-width duration-${progressTransitionDuration} ease-linear h-full rounded-md bg-gradient-to-tr from-indigo-600/60 to-purple-700/60` } style={{ width: `${progress * 100}%` }} />
                    <div className="absolute top-1/4 p-6 text-center overflow-hidden">
                        <p className="text-xl font-medium text-blue-950">Uploading {filename}...</p>
