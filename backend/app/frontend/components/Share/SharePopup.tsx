...
type SharePopupProps = {
    ...
    setHasLinkPassword: (value: boolean) => void
}

export const SharePopup = ({resourceId, onClose, hasLinkPassword, setHasLinkPassword}: SharePopupProps) => {
    ...
    const handleSubmit = useCallback(async (values: ShareFormValues, bag: FormikHelpers<ShareFormValues>) => {
    ...
    const onSwitchToggle = useCallback(async (value: boolean) => {
