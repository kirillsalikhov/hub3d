    ...
    <div className="col-span-full">
        <form>
            <div htmlFor="dropzone-file-upload" { ...rootProps }>
                ...
                <div className={ `${ isDragActive ? 'bg-gradient-to-tr' : '' } group cursor-pointer relative flex rounded-lg h-80 bg-white hover:bg-gradient-to-tr from-blue-500 via-pink-300 via-70% to-purple-600 border-2 border-dashed border-gray-300 hover:border-none` }>
